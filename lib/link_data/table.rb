...
module LinkData
  class LinkData::Table
    ...
    def self.parse(table_uri)
      ...
      table.schema = LinkData::Schema.new
      table.schema.creator = LinkData::Person.new
      ...
      lines.each_with_index do |line, index|
        ...
        case line.first
        when /^#/
          LinkData::Table.parse_comment_line(lines, current_line, table.schema)
        else
          LinkData::Table.parse_data_line(lines, current_line, table.schema)
        end
      end
